...
newhtml = ""
for (let i=0;i<10;i++){
newhtml = newhtml + `<div class="main" style="width: 1200px; height: 500px;">test</div>`
}
...
function del_div(i){
var e = document.getElementsByClassName('main')[i]
document.getElementsByClassName('test')[0].removeChild(e);
}
<!--echarts.init(test.getElementsByClassName('main')[0]).setOption(option);-->
<!--echarts.init(test.getElementsByClassName('main')[1]).setOption(option);-->
for (let i=0; i<10;i++){

echarts.init(test.getElementsByClassName('main')[i]).setOption(option);
<!--test.getElementsByClassName('main')[i].innerHTML=`<button type="button" class="button btn-light" id="add-btn" onclick="del_div(${i})">删除${i}</button>`-->
var del_but = document.creatElement('del')
del_but.type = 'button';
del_but.value = '删除';
test.getElementsByClassName('main')[i].appendChild(del_but);
}
